...
class WeatherRepository {
  ...
  Future<Weather> getWeather(String city) async {
    ...
    final woied = location.woeid;
    final weather = await _weatherApiClient.getWeather(woied);
    return Weather(temperature: weather.theTemp, location: location.title,condition: weather.weatherStateAbbr.toCondition);
  }
}
